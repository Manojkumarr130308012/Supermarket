...
import com.example.supermarket.BuildConfig;
import com.example.supermarket.Model.PDFModel;
import com.example.supermarket.R;
import com.example.supermarket.utils.PDFCreationUtils;
...
public class Salesreport extends AppCompatActivity implements View.OnClickListener {
    ...
    private void createPDFFile() {
        ...
        PDFCreationUtils.clearMemory();
        PDFCreationUtils.initBitmapCache(getApplicationContext());
        final PDFCreationUtils pdfCreationUtils = new PDFCreationUtils(Salesreport.this, pdfDataList, LIST_SIZE, NO_OF_PDF_FILE);
        if (NO_OF_PDF_FILE == 1) {
        ...
        pdfCreationUtils.createPDF(new PDFCreationUtils.PDFCallback() {
            ...
            public void onComplete(final String filePath) {
                ...
                if (filePath != null) {
                    ...
                    Toast.makeText(Salesreport.this, "pdf file " + filePath, Toast.LENGTH_LONG).show();
            ...
            public void onError(Exception e) {
                Toast.makeText(Salesreport.this, "Error  " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
